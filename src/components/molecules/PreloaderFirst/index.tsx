...
interface PreloaderFirstProp {
  onpress: () => void;
}

const PreloaderFirst = ({onpress}: PreloaderFirstProp): JSX.Element => {
  ...
  return (
    <View style={style.container}>
      <Image
        source={require('../../../assets/images/artboard69@1.png')}
        style={style.img}
      />
      <Text style={style.title}>Выгодные покупки</Text>
      <Text style={style.descr}>
        Оформите карту лояльности в приложении и получайте скидки на товары и
